...
let tasks = [
    ...
    { id: 't4', title: 'Generate Q3 Threat Report', status: 'active', assignee: 'Priya Patel' }
];
...
function initAI() {
    ...
    const sendAIMessage = () => {
        ...
        setTimeout(() => {
            ...
            const randomReply = socReplies[Math.floor(Math.random() * socReplies.length)];
            const aiMsg = document.createElement('div');
            aiMsg.className = 'message';
            aiMsg.innerHTML = `<div class="message-bubble">${randomReply}</div>`;
